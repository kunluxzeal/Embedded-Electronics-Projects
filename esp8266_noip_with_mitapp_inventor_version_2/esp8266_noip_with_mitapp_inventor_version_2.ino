...
String server = "41.242.79.226"; // initialize variable to store server address
...
void setup() {
  ...
  // Wait for user to input the server address using TextInput component from MIT App Inventor
  while (server == "") {
    delay(500);
  }
...
void loop() {
 ...
 // Check if the command is to turn on the relay
    ...
    // Repeat for the other relays as needed
